# Khanij — Claude Code Instructions

## Project Identity

**Khanij** (Hindi/Sanskrit: खनिज — mineral) — Geology and mineralogy engine for AGNOS
...
AGNOS science stack, kiran (game engine), joshua (simulation), any app needing geological/mineral data.
...
- Own the domain — khanij IS the geology/mineralogy vocabulary
