use khanij::{
    ...
    SoilComposition, chemical_weathering_rate, erosion_rate, is_economically_viable,
...
fn main() {
    ...
    println!("\n=== Crystal Systems ===");
    println!(
        "Cubic symmetry order: {}",
        CrystalSystem::Cubic.symmetry_order()
    );
    println!(
        "Triclinic symmetry order: {}",
    ...
    println!(
        "{} {:?} deposit: grade {}, depth {}m, tonnage {}t",
